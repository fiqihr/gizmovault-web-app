...
<a {{ $attributes->merge(['class' => 'flex items-center px-4 py-2 text-sm leading-5 text-gray-700 dark:text-gray-300 focus:outline-none transition duration-150 ease-in-out']) }}>
  {{ $slot }}
</a>
